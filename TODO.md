...
simplesolat-data/
  ...
  scripts/                         # fetch, extraction, and generation scripts
    ...
    extract_acju.py                # sources/acju/sources.yaml → data/prayer-times/LK/
...
- [x] Create extract_acju.py (parallel download + pdfplumber extraction)
...
- [x] extract_acju — downloads PDFs from sources.yaml, extracts via pdfplumber
...
- Extracted via scripts/extract_acju.py (pdfplumber, parallel download)
